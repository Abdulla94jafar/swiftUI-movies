...
//  movies
//
//  Created by Abdulla Jafar on 3/26/21.
//
...
struct SegmentedPicker: View {
    private static let ActiveSegmentColor: Color = Color.mainColor
    private static let BackgroundColor: Color = .white
    private static let ShadowColor: Color = Color.mainColor.opacity(0.5)
    private static let TextColor: Color = .coolBlack
    ...
    private var activeSegmentView: AnyView {
        ...
        return
            RoundedRectangle(cornerRadius: SegmentedPicker.SegmentCornerRadius)
                ...
                .frame(width: self.segmentSize.width, height: 50)
...
struct PreviewView: View {
    ...
    private let items: [String] = ["M", "T", "W", "T",]
